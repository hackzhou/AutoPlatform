...
<nav class="navbar navbar-default navbar-static-top m-b-0">
	<div class="navbar-header"> <a class="navbar-toggle hidden-sm hidden-md hidden-lg " href="javascript:void(0)" data-toggle="collapse" data-target=".navbar-collapse"><i class="ti-menu"></i></a>
		<div class="top-left-part"><a class="logo" href="${pageContext.request.contextPath}/home/index"><b><img src="${pageContext.request.contextPath}/plugins/images/eliteadmin-logo.png" alt="home" /></b><span class="hidden-xs">玩蜂科技测试平台</span></a></div>
		<ul class="nav navbar-top-links navbar-left hidden-xs top-menu-all">
			...
			<ul class="dropdown-menu dropdown-user animated flipInY">
				<li><a href="${pageContext.request.contextPath}/tool/status/page"><i class="fa fa-tablet m-r-10"></i> 项目测试状态</a></li>
				<li><a href="${pageContext.request.contextPath}/tool/pressure/page"><i class="fa fa-rocket m-r-10"></i> 压力测试-持久连接</a></li>
