...
public class ApiAutoTask {
	...
	private void runTask(ATask aTask) throws Exception{
		...
		apiRunService.run(ApiRunType.PROJECT, pid, aid, vid, "Auto[" + aTask.getRunby() + "]", aTask.getCompare(), aTask.getPlatform(), new Integer(1).equals(aTask.getMail()), aTask.getEmail());
